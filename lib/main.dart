    ...
    return Scaffold(
      body: Container(
        decoration: const BoxDecoration(
          gradient:
              LinearGradient(colors: [Color(0xFF2962FF), Color(0xFF00C853)]),
        ),
        child: Center(
          child: Card(
            shape:
          ...
          Card(
            child: Column(children: [
              ListTile(
                  ...
                  trailing: Text("${(co2 * 0.7).toStringAsFixed(0)} kg")),
              ListTile(
                  title: const Text("Usage"),
                  trailing: Text("${(co2 * 0.2).toStringAsFixed(0)} kg")),
              ListTile(
                  title: const Text("End-of-Life"),
                  trailing: Text("${(co2 * 0.1).toStringAsFixed(0)} kg")),
            ]),
          ),
...
class _HistoryPageState extends State<HistoryPage> {
  ...
  Widget build(BuildContext context) {
    var data = history
        .where((e) => e["device"].toLowerCase().contains(search.toLowerCase()))
        .toList();
...
class InfoPage extends StatelessWidget {
  ...
  void showInfo(BuildContext context, String title, String desc, IconData icon,
      Color color) {
